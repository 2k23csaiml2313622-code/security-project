...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("entered get transformer object method")
        try:
    ...
    def initiate_data_transformation(self)->DatTransformationArtifact:
        ...
        try:
            ...
            # training df
            # In initiate_data_transformation method
            ...
            target_feature_test_df = target_feature_test_df.replace(-1, 0) # Corrected variable
